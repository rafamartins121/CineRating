...
namespace CineRating.Controllers
{
    public class PessoasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nome,DataNascimento,Biografia")] Pessoas pessoas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nome,DataNascimento,Biografia")] Pessoas pessoas)
        {
            if (ModelState.IsValid)
            {
