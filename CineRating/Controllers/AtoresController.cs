...
namespace CineRating.Controllers
{
    public class AtoresController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,Nome,DataNascimento,Biografia")] Atores atores)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,Nome,DataNascimento,Biografia")] Atores atores)
        {
            if (ModelState.IsValid)
            {
