    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CineRating.Models.CineRatingDb> {
        ...
        protected override void Seed(CineRating.Models.CineRatingDb context) {
            ...
            var filmes = new List<Filmes> {
                new Filmes {ID=1, Titulo = "Vingadores: Guerra do Infinito", Descricao="Homem de Ferro, Thor, Hulk e os Vingadores se unem para combater seu inimigo mais poderoso, o maligno Thanos. Em uma missão para coletar todas as seis pedras infinitas, Thanos planeja usá-las para infligir sua vontade maléfica sobre a realidade.", TempoExecucao=160, DataLancamento= new DateTime(2018,4,23), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[0], generos[1] } },
                new Filmes {ID=2, Titulo = "Um Lugar Silencioso", Descricao="Em uma fazenda nos Estados Unidos, uma família do Meio-Oeste é perseguida por uma entidade fantasmagórica assustadora. Para se protegerem, eles devem permanecer em silêncio absoluto, a qualquer custo, pois o perigo é ativado pela percepção do som.", TempoExecucao=95, DataLancamento= new DateTime(2018,4,3), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[1], generos[2] }},
                new Filmes {ID=3, Titulo = "Beirut", Descricao="Beirut é um filme de drama estadunidense de 2018 dirigido e escrito por Brad Anderson e Tony Gilroy. Estrelado por Jon Hamm, Rosamund Pike, Dean Norris e Shea Whigham, estreou no Festival Sundance de Cinema em 22 de janeiro de 2018.", TempoExecucao=109, DataLancamento= new DateTime(2018,4,11), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[2], generos[5] }},
                new Filmes {ID=4, Titulo = "Rampage: Fora de Controle", Descricao="Davis Okoye é um primatologista, um homem recluso que compartilha um vínculo inabalável com George, um gorila muito inteligente que está sob seus cuidados desde o nascimento.", TempoExecucao=115, DataLancamento= new DateTime(2018,4,12), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[5], generos[3] }},
                new Filmes {ID=5, Titulo = "Desejo de Matar", Descricao="Após ter sua casa invadida e esposa assassinada por bandidos, Paul passa a acompanhar a polícia nas investigações para capturar os criminosos.", TempoExecucao=108, DataLancamento= new DateTime(2018,3,2), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[7], generos[8] }},
                new Filmes {ID=6, Titulo = "The Forgiven", Descricao="Musawq", TempoExecucao=115, DataLancamento= new DateTime(2018,3,9), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[2], generos[7] }},
                new Filmes {ID=7, Titulo = "Ready Player One: Jogador 1", Descricao="Em 2044, Wade Watts, assim como o resto da humanidade, prefere a realidade virtual do jogo OASIS ao mundo real. ", TempoExecucao=139, DataLancamento= new DateTime(2018,3,29), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[8], generos[9] }},
                new Filmes {ID=8, Titulo = "As Boas Maneiras", Descricao="Ana contrata Clara, uma solitária enfermeira moradora da periferia de São Paulo, para ser babá de seu filho ainda não nascido. Conforme a gravidez vai avançando, Ana começa a apresentar comportamentos cada vez mais estranhos.", TempoExecucao=135, DataLancamento= new DateTime(2018,3,21), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[0], generos[1] }},
                new Filmes {ID=9, Titulo = "Colo", Descricao="Em Portugal, uma família de classe média passa por uma grave crise financeira. O pai perde o emprego e não consegue encontrar outro trabalho, a mãe consegue acha uma segunda ocupação para aumentar a renda, mas anda sempre cansada e mal para em casa.", TempoExecucao=136, DataLancamento= new DateTime(2017,4,23), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[1], generos[3] }},
                new Filmes {ID=10, Titulo = "The Jungle Bunch", Descricao="Hnoe.", TempoExecucao=97, DataLancamento= new DateTime(2017,9,7), Imagem="", Video="", RealizadorFK=1, ListaDeGeneros = new List<Generos> { generos[1], generos[3] }},
            };
