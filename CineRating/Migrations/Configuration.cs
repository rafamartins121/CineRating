    ...
    internal sealed class Configuration : DbMigrationsConfiguration<CineRating.Models.CineRatingDb> {
        ...
        protected override void Seed(CineRating.Models.CineRatingDb context) {
            ...
            var atores = new List<Atores> {
                ...
                new Atores {ID=11, Nome = "Zoë Saldaña", DataNascimento=new DateTime(1978,6,19), Biografia="Zoe Yadira Saldaña Nazario é uma atriz estadunidense. Saldana fez sua estréia na tela em um episódio de Law & Order. Sua carreira no cinema começou um ano depois com o filme Center Stage, seguido por Crossroads.", Imagem="ZoeSaldana.jpg"},
